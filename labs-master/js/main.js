var trigger=0, name, age, sex, education, mathematic, asu, cutting, programming, surname, opitrab; // обьявляем переменные которые понадобятся в ходе работы
...
motiv = confirm("Был ли опыт работы?");
writeToPage();
}
...
document.getElementById("opitrab").checked = opitrab;
trigger=1;
myFunction();
}
